# Sliddify Code of Conduct

## Our Community

The **Sliddify** community is made up of contributors, developers, designers, researchers, and users from all around the world. Together we are building an open-source platform for **AI-powered presentation generation**.
...
This Code of Conduct applies to all spaces managed by the **Sliddify project**, including but not limited to:

- GitHub repositories (issues, pull requests, discussions)
- Official documentation
- Discord community
- Social media interactions
- Events, meetups, or presentations related to Sliddify

Violations of this code outside these spaces may also affect a person’s ability to participate in the Sliddify community.
...
Everyone should feel safe and respected when participating in the Sliddify community.

---

### 🧠 Be Considerate

Your work and decisions may impact others who rely on Sliddify. Think about how your contributions affect:
...
This Code of Conduct is inspired by guidelines from open-source communities and the **Speak Up! project**, adapted for the Sliddify community.
...
Thank you for helping make **Sliddify a welcoming and collaborative open-source project.**
