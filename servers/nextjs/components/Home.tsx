...
import SliddifyMode from "./OnBoarding/SliddifyMode";
...
export default function Home() {
  ...
  const [selectedMode, setSelectedMode] = useState<string>("sliddify")
  ...
  return (
    ...
    <div className="flex min-h-screen relative">
      ...
      <main className="w-full pl-20 pr-8 max-w-[1440px] mx-auto relative z-10">
        ...
        {step === 2 && selectedMode === "sliddify" && <SliddifyMode currentStep={step} setStep={setStep} />}
