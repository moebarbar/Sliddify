...
const SettingsPage = () => {
  ...
  const [mode, setMode] = useState<'nanobanana' | 'sliddify'>('sliddify')
    ...
    <div className="h-screen font-syne flex flex-col overflow-hidden relative">
      ...
      <main className="w-full mx-auto gap-6   overflow-hidden flex ">
        ...
        <div className="w-full">
          ...
          {mode === 'sliddify' && selectedProvider === 'text-provider' && <TextProvider
            ...
            llmConfig={llmConfig}
          />}
          {mode === 'sliddify' && selectedProvider === 'image-provider' && <ImageProvider llmConfig={llmConfig} setLlmConfig={setLlmConfig} />}
