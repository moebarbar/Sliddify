...
export const Schema = z.object({
    ...
    email: z.string().max(30).describe('Email address text').default('sliddify@gmail.com'),
    website: z.string().max(30).describe('Website URL text').default('www.sliddify.com'),
