...
# Simple branded success page for Sliddify authentication
SUCCESS_HTML = """<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  <title>Sliddify – Authentication successful</title>
  <style>
    :root {
...
<body>
  <main class="card">
    ...
    <p>You can now return to Sliddify to continue.</p>
...
<head>
  <meta charset="utf-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  <title>Sliddify – Authentication issue</title>
  <style>
...
<body>
  <main class="card">
    ...
    <p>We’ll gently reload this page. If the issue persists, close this window and restart sign-in from Sliddify.</p>
